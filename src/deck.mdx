...
<ul>
  ...
  <li>Comparison with Standard Views</li>
...
<ul>
  <Appear>
    ...
    <li>Results of Precomputed Query</li>
    <li>Differences from Regular Views</li>
  </Appear>
</ul>
